            ...
            <div>
                ...
                <div className="row aboutRow mt-5 mb-5">
                    ...
                    <div className="col-md-6 col-sm-12">
                        ...
                        <div className="row aboutInfo d-flex align-items-center text-center justify-content-center mb-4 ml-1">
                            <div className="projectsWrapper p-4">
                                <h4 className="smallDark">I am a full-stack software developer and an avid learner. I design modern websites, build fully functional software applications, and have experience making full CRUD applications powered by Python, React, and JAVA that manipulate and store data through MySQL and MongoDB.</h4>
                            </div>
                        </div>
                    </div>
